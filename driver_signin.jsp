...
<div class="col-sm-5;container-fluid; " style="background-color:white;float:center; height:750px; width:500px;border: 10px dotted red;padding:35px;background-clip: padding-box;">
 <span class="badge badge-info" style="width:275px; height:65px; align:justify-center; "><h1>Driver Login-In</h1></span>
...
<form action="/action_page.php">
  ...
  <div class="container">
    <label for="uname"><b>Driver name</b></label>
    <input type="text" placeholder="Enter drivername" name="uname" required>
