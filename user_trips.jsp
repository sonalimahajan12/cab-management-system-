...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
  <a class="navbar-brand"  style="margin-left:600px " href="HOMEPAGE1.htm">
      <img src="logo.png" alt="Paris" style="width:150px; border: 1px solid #ddd;
    border-radius: 4px;
    padding: 5px;
    width: 150px;
  ...
  <div class="container-fluid">
      <div class="col-md " style="height:700px;width:1000px;float:right;"><br><br><br><br><br><h1 style="margin-left:400px; ">Trips</h1><hr>
...
<ul style="height:600px;width:300px;">
    <br>
  <img src="hada.jpeg" style="margin-left:90px;" class="img-thumbnail"  width="104" height="86"> 
  <br><br><br>
  ...
  <li><a class="active" style="height:60px;width:300px;" href="user_trips.jsp">My Trips</a></li>
